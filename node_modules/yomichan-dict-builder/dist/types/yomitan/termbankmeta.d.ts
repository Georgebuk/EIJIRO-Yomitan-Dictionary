type TermFrequency = string | number | {
    value: number;
    displayValue: string;
};
type FrequencyTerm = [
...
export type { DictionaryTermMetaBankV3, TermFrequency, TermMetaEntryType, PitchAccentInfo, PitchTerm, FrequencyTerm, TermPhoneticTranscription, };
