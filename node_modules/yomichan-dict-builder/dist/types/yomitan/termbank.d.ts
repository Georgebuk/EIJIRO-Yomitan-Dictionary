type DetailedDefinition = string | {
    type: 'text';
    text: string;
} | {
...
type StructuredContentStyle = {
    ...
    textDecorationLine?: 'none' | 'underline' | 'overline' | 'line-through' | ('underline' | 'overline' | 'line-through')[];
...
type StructuredContentNode = string | StructuredContentNode[] | {
    tag: 'br';
...
export type { DictionaryTermBankV3, DetailedDefinition, StructuredContent, StructuredContentData, StructuredContentNode, StructuredContentStyle, TermInformation, };
